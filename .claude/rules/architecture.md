...
- `WRITE_TOOLS` in `apps/api/src/investigation/loop.ts` is the approval gate. Any new remediation tool must be added to this set before its handler is wired up — never after.
